...
plot_fun <- function (p, x, funplot, plot_fun=FALSE, main='close') {
...
plot_fun("close/acf_close.png", data_col, acf)
plot_fun("close/pacf_close.png", data_col, pacf)
plot_fun("close/close.png", data_col[,1], plot, plot_fun=TRUE,main='close')
...
plot_fun("close/acf_close_diff.png", data_col_diff, acf)
plot_fun("close/pacf_close_diff.png", data_col_diff, pacf)
plot_fun("close/close_diff.png", data_col_diff, plot, plot_fun=TRUE,main='close Diff')
...
# forecasting using each model
n_forecast <- 1000
plot_fun(
  "close/forecase_close_arma22.png",
...
plot_fun(
  "close/forecase_close_arma20.png",
...
plot_fun(
  "close/forecase_close_arma02.png",
